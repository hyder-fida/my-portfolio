...
const Header = () => {
  ...
  const downloadResume = () => {
    ...
    link.href = 'https://drive.google.com/file/d/1BRe7Fse156s7nVbCWhvR5GGqJaakGFtF/view?usp=drive_link'; // Place your resume PDF in the public folder
      ...
      <nav className="container-max">
        <div className="flex items-center justify-between h-16">
          ...
          <div className="flex-shrink-0">
            <h1 className="text-2xl font-bold text-white">Fida Hussain 
            mir</h1>
          </div>
